...
/*Functions can go outside a level but cannot go deeper into another nested funtion in other words
it is in scope */
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(arr){
   return arr.map(i => i.animal_name.toLowerCase());
  }
  ...
  */
  ...
  function USApop(arr){
    return arr.reduce((acc,item) => acc + item.population,0)
  }
